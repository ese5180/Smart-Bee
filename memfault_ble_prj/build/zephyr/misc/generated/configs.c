...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MDS_DATA_POLL_INTERVAL, 30000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 200000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLEFUNCTION, 1);
